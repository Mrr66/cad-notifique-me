            ...
            <Grid.Column style={{ maxWidth: 690 }}>
              <Header as='h2' color='teal' textAlign='center'>
                ...
                <div class="ui success message">
                    ...
                    <p>Ao cadastrar a empresa compromete em respeitar os requisitos de uso da API Notifique-me.</p>
                     ...
                     <div class="header">Responsabilidade comercial</div>
                     <p>Pagar dentro do prazo a fatura referente ao mês de uso, sendo que a tolerância é de apenas 5 dias, se o sistema não reconhecer o pagamento até a tolerância as chaves de acesso serão canceladas impedindo o envio de notificação.</p>
...
export default function (){
    document.title = "Cadastre sua empresa";
    return <Etapa1/>;
}
