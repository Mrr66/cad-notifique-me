    ...
    render () {
        ...
        return (
            <form onSubmit={this.handleSubmitSignUp}>
                ...
                <div className="form-group col-md-4">
                    <label htmlFor="emailSignUpInput col-md-4">E-mail</label>
                ...
                <button disabled={this.state.submittingSignUp} type="submit" className="btn btn-success">Cadastrar</button>
            </form>
        )
    }
}
